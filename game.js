...
function displayKeyName(key) {
  const names = {
    ...
    shift: "Shift",
    alt: "Alt / Option",
    meta: platform === "mac" ? "âŒ˜ Cmd" : "Windows",
    tab: "Tab",
    escape: "Esc",
    space: "Space"
  };
